		...
		for _, update := range updates {
			...
			if logged == 1 {
				...
				default:
					...
					Из бота можно отправлять сообщение в переписку на портал.
					Чтобы это сделать – просто ответьте на сообщение бота. Сделать это можно длинным нажатием - ответить (на телефоне), или Правая кнопка мыши – ответить (на ПК)
				...
				case update.Message.Text == "/start":
					...
					Я умею оповещать тебя о сообщениях, которые направляют тебе твои коллеги. Через меня можно отправить сообщение прямо на портал (Чтобы это сделать – просто ответьте на сообщение от меня. Сделать это можно длинным нажатием - ответить (на телефоне), или Правая кнопка мыши – ответить (на ПК)) Скоро я смогу оповещать тебя о новых кейсах, поступивших в работу, научусь лучше настраиваться под твои нужды, и еще очень многое.
